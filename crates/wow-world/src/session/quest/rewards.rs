...
impl WorldSession {
    ...
    pub(in crate::session) fn represented_quest_rewarded_talent_points_like_cpp(
        ...
        if canonical.is_none() && self.player_handle_like_cpp.is_none() {
            return Some(
                self.quest_test_fixture_like_cpp.represented_quest_reward_talent_points_like_cpp
                    .iter()
    ...
    pub(crate) fn add_represented_quest_reward_talent_points_like_cpp(
        ...
        if self.player_handle_like_cpp.is_none() {
            self.quest_test_fixture_like_cpp.represented_quest_reward_talent_points_like_cpp.push(
    ...
    pub(in crate::session) fn set_loaded_quest_completed_bit_like_cpp(
        ...
        if self.player_handle_like_cpp.is_none() {
            return self
                .quest_test_fixture_like_cpp.represented_quest_completed_bits_like_cpp
                .insert(quest_bit);
        }
        canonical_changed
    }
    ...
    pub(crate) fn represented_quest_reward_spell_casts_like_cpp(
        ...
        &self.quest_test_fixture_like_cpp.represented_quest_reward_spell_casts_like_cpp
    }
    #[cfg(test)]
    pub(crate) fn represented_quest_reward_titles_like_cpp(
        &self,
    ) -> &[RepresentedQuestRewardTitleLikeCpp] {
        &self.quest_test_fixture_like_cpp.represented_quest_reward_titles_like_cpp
    }
    #[cfg(test)]
    ...
    pub(crate) fn represented_quest_reward_reputations_like_cpp(
        ...
        &self.quest_test_fixture_like_cpp.represented_quest_reward_reputations_like_cpp
    }
