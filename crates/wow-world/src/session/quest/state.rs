...
impl WorldSession {
    ...
    fn player_quest_gameplay_fixture_like_cpp(&self) -> PlayerQuestGameplayState {
        ...
        state.replace_statuses_like_cpp(
            self.quest_test_fixture_like_cpp.player_quests
                ...
                .collect(),
            self.quest_test_fixture_like_cpp.player_quest_status_authority_complete_like_cpp,
        );
        state.replace_rewarded_quest_ids_like_cpp(self.quest_test_fixture_like_cpp.rewarded_quests.iter().copied().collect());
        state.replace_daily_quest_ids_like_cpp(
            self.quest_test_fixture_like_cpp.daily_quests_completed_like_cpp
                .iter()
                .copied()
                .collect(),
        );
        state.replace_weekly_quest_ids_like_cpp(
            self.quest_test_fixture_like_cpp.weekly_quests_completed_like_cpp
                .iter()
                .copied()
                .collect(),
        );
        state.replace_monthly_quest_ids_like_cpp(
            self.quest_test_fixture_like_cpp.monthly_quests_completed_like_cpp
                .iter()
                .copied()
                .collect(),
        );
        state.replace_seasonal_quests_like_cpp(
            self.quest_test_fixture_like_cpp.seasonal_quests_like_cpp.clone(),
            self.quest_test_fixture_like_cpp.seasonal_quest_changed_like_cpp,
        );
        state.replace_df_quest_ids_like_cpp(self.quest_test_fixture_like_cpp.df_quests_like_cpp.iter().copied().collect());
        state.set_last_daily_quest_time_secs_like_cpp(self.quest_test_fixture_like_cpp.last_daily_quest_time_like_cpp);
        state.replace_rewarded_quest_rows_like_cpp(
            self.quest_test_fixture_like_cpp.represented_rewarded_quest_rows_like_cpp.clone(),
        );
    ...
    fn apply_player_quest_gameplay_fixture_like_cpp(&mut self, state: PlayerQuestGameplayState) {
        ...
        self.quest_test_fixture_like_cpp.seasonal_quests_like_cpp = state.seasonal_quests_snapshot_like_cpp();
        self.quest_test_fixture_like_cpp.df_quests_like_cpp = state.df_quest_ids_like_cpp().iter().copied().collect();
        self.quest_test_fixture_like_cpp.last_daily_quest_time_like_cpp = state.last_daily_quest_time_secs_like_cpp();
        self.quest_test_fixture_like_cpp.seasonal_quest_changed_like_cpp = state.seasonal_quest_changed_like_cpp();
    }
    #[cfg(test)]
    fn apply_player_quest_core_compatibility_like_cpp(&mut self, state: &PlayerQuestGameplayState) {
        ...
        self.quest_test_fixture_like_cpp.represented_rewarded_quest_rows_like_cpp =
    ...
    pub(crate) fn set_represented_pending_quest_sharing_like_cpp(
        ...
        #[cfg(test)]
        if self.player_handle_like_cpp.is_none() {
            self.quest_test_fixture_like_cpp.represented_pending_quest_sharing_like_cpp =
    ...
    pub(crate) fn clear_represented_pending_quest_sharing_like_cpp(&mut self) {
        #[cfg(test)]
        if self.player_handle_like_cpp.is_none() {
            self.quest_test_fixture_like_cpp.represented_pending_quest_sharing_like_cpp = None;
            self.sync_player_registry_state_like_cpp();
            return;
        }
        let _ = self.mutate_player_quest_gameplay_like_cpp(|state| {
    ...
    pub(crate) fn represented_pending_quest_sharing_like_cpp(
        ...
        #[cfg(test)]
        if self.player_handle_like_cpp.is_none() {
            return self.quest_test_fixture_like_cpp.represented_pending_quest_sharing_like_cpp;
        }
    ...
    pub(crate) fn represented_quest_push_result_responses_like_cpp(
        ...
        &self.quest_test_fixture_like_cpp.represented_quest_push_result_responses_like_cpp
    }
    ...
    pub(crate) fn record_represented_quest_push_result_sender_mismatch_like_cpp(&mut self) {
        #[cfg(test)]
        {
            self.quest_test_fixture_like_cpp.represented_quest_push_result_sender_mismatch_count_like_cpp = self
                .quest_test_fixture_like_cpp.represented_quest_push_result_sender_mismatch_count_like_cpp
                .saturating_add(1);
        }
    }
    #[cfg(test)]
    pub(crate) fn represented_quest_confirm_accepts_like_cpp(
        ...
        &self.quest_test_fixture_like_cpp.represented_quest_confirm_accepts_like_cpp
    }
    ...
    pub(crate) fn represented_push_quest_to_party_outcomes_like_cpp(
        ...
        &self.quest_test_fixture_like_cpp.represented_push_quest_to_party_outcomes_like_cpp
    }
