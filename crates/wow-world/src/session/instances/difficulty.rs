...
impl WorldSession {
    ...
    pub(crate) fn player_difficulty_preferences_snapshot_like_cpp(
        ...
        if canonical.is_none() && self.player_handle_like_cpp.is_none() {
            return Some((
                self.instance_test_fixture_like_cpp.represented_dungeon_difficulty_id_like_cpp,
                self.instance_test_fixture_like_cpp.represented_raid_difficulty_id_like_cpp,
                self.instance_test_fixture_like_cpp.represented_legacy_raid_difficulty_id_like_cpp,
            ));
        }
        canonical
    }
    pub(in crate::session) fn replace_player_difficulty_preferences_like_cpp(
        ...
        if self.player_handle_like_cpp.is_none() {
            self.instance_test_fixture_like_cpp.represented_dungeon_difficulty_id_like_cpp = dungeon;
            self.instance_test_fixture_like_cpp.represented_raid_difficulty_id_like_cpp = raid;
            self.instance_test_fixture_like_cpp.represented_legacy_raid_difficulty_id_like_cpp = legacy_raid;
            return true;
        }
        canonical
    }
        ...
        if self.player_handle_like_cpp.is_none() {
            match kind {
                SessionDifficultyKindLikeCpp::Dungeon => {
                    self.instance_test_fixture_like_cpp.represented_dungeon_difficulty_id_like_cpp = difficulty_id;
                }
                SessionDifficultyKindLikeCpp::Raid => {
                    self.instance_test_fixture_like_cpp.represented_raid_difficulty_id_like_cpp = difficulty_id;
                }
                SessionDifficultyKindLikeCpp::LegacyRaid => {
                    self.instance_test_fixture_like_cpp.represented_legacy_raid_difficulty_id_like_cpp = difficulty_id;
                }
            }
            return true;
        }
