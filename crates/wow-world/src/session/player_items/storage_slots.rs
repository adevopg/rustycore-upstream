...
impl WorldSession {
    ...
    pub(crate) fn set_player_inventory_slot_count_like_cpp(&mut self, count: u8) -> bool {
        ...
        if canonical || self.player_handle_like_cpp.is_none() {
            self.player_item_test_fixture_like_cpp.player_inventory_slot_count_like_cpp = count;
        }
    ...
    pub(crate) fn resolved_player_inventory_slot_count_like_cpp(&self) -> Option<u8> {
        ...
        if canonical.is_none() && self.player_handle_like_cpp.is_none() {
            return Some(self.player_item_test_fixture_like_cpp.player_inventory_slot_count_like_cpp);
        }
        canonical
    }
    #[cfg(test)]
