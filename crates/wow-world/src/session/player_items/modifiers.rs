...
impl WorldSession {
    ...
    pub(in crate::session) fn player_item_modifier_runtime_snapshot_like_cpp(
        ...
        if canonical.is_none() && self.player_handle_like_cpp.is_none() {
            return Some(self.player_item_test_fixture_like_cpp.represented_item_modifier_runtime_like_cpp.clone());
        }
        canonical
    }
    ...
    pub(in crate::session) fn add_player_item_set_item_like_cpp(
        ...
        if self.player_handle_like_cpp.is_none() {
            return Some(
                self.player_item_test_fixture_like_cpp.represented_item_modifier_runtime_like_cpp
    ...
    pub(in crate::session) fn record_represented_item_mods_like_cpp(
        ...
        #[cfg(test)]
        {
            self.player_item_test_fixture_like_cpp.represented_item_mod_reapply_events_like_cpp.push(
    ...
    pub(crate) fn record_represented_update_item_set_auras_like_cpp(
        ...
        #[cfg(test)]
        self.player_item_test_fixture_like_cpp.represented_item_set_aura_refresh_events_like_cpp
    ...
    pub(in crate::session) fn reset_represented_item_bonus_runtime_like_cpp(&mut self) {
        ...
        #[cfg(test)]
        self.player_item_test_fixture_like_cpp.represented_item_bonus_actions_like_cpp.clear();
