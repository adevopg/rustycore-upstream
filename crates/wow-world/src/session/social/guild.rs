...
impl WorldSession {
    fn player_guild_state_snapshot_like_cpp(&self) -> Option<wow_entities::PlayerGuildState> {
        ...
        if canonical.is_none() && self.player_handle_like_cpp.is_none() {
            return Some(wow_entities::PlayerGuildState {
                guild_id: (self.guild_test_fixture_like_cpp.represented_guild_id_like_cpp != 0)
                    .then_some(self.guild_test_fixture_like_cpp.represented_guild_id_like_cpp),
                invited_guild_id: (self.guild_test_fixture_like_cpp.represented_guild_id_invited_like_cpp != 0)
                    .then_some(self.guild_test_fixture_like_cpp.represented_guild_id_invited_like_cpp),
                rank_id: None,
                authority_complete: self.guild_test_fixture_like_cpp.represented_guild_id_authority_complete_like_cpp,
            });
        }
        canonical
    }
    ...
    fn mutate_player_guild_state_like_cpp<R>(
        ...
        self.guild_test_fixture_like_cpp.represented_guild_id_like_cpp = state.guild_id.unwrap_or(0);
        self.guild_test_fixture_like_cpp.represented_guild_id_invited_like_cpp = state.invited_guild_id.unwrap_or(0);
        self.guild_test_fixture_like_cpp.represented_guild_id_authority_complete_like_cpp = state.authority_complete;
        Some(result)
    }
    ...
    pub(crate) fn accept_guild_invitation_like_cpp(&mut self) -> bool {
        ...
        #[cfg(test)]
        self.guild_test_fixture_like_cpp.represented_guild_accept_invites_like_cpp
            .push(guild_id);
        true
    }
    #[cfg(test)]
