...
impl WorldSession {
    ...
    pub(crate) fn handle_can_duel_like_cpp(&mut self, target_guid: ObjectGuid, to_the_death: bool) {
        ...
        if result {
            ...
            #[cfg(test)]
            self.duel_test_fixture_like_cpp.represented_can_duel_spell_casts_like_cpp.push(
    ...
    pub(crate) fn set_represented_duel_arbiter_guid_like_cpp(&mut self, guid: Option<ObjectGuid>) {
        ...
        if !canonical && self.player_handle_like_cpp.is_none() {
            self.duel_test_fixture_like_cpp.represented_duel_arbiter_guid_like_cpp = guid;
        }
        #[cfg(not(test))]
        let _ = canonical;
    }
    pub(crate) fn resolved_represented_duel_arbiter_guid_like_cpp(
        ...
        if self.player_handle_like_cpp.is_none() {
            return Some(self.duel_test_fixture_like_cpp.represented_duel_arbiter_guid_like_cpp);
        }
        None
    }
    ...
    fn handle_duel_accepted_like_cpp(&mut self, arbiter_guid: ObjectGuid) -> bool {
        ...
        #[cfg(test)]
        self.duel_test_fixture_like_cpp.represented_duel_accepts_like_cpp
    ...
    fn handle_duel_cancelled_like_cpp(&mut self) -> bool {
        ...
        #[cfg(test)]
        self.duel_test_fixture_like_cpp.represented_duel_cancels_like_cpp
