...
impl WorldSession {
    pub(crate) fn record_represented_trade_cancel_like_cpp(&mut self, status: u8) {
        #[cfg(test)]
        self.trade_test_fixture_like_cpp.represented_trade_cancel_statuses_like_cpp.push(status);
        #[cfg(not(test))]
        let _ = status;
    }
            ...
            return Some(
                self.trade_test_fixture_like_cpp.represented_active_trade_partner_like_cpp
                    .map(|partner_guid| wow_entities::PlayerTradeStateLikeCpp {
                        partner_guid,
                        accepted: self.trade_test_fixture_like_cpp.represented_trade_accepted_like_cpp,
                        partner_server_state_index: self
                            .represented_partner_trade_server_state_index_like_cpp,
                        client_state_index: self.trade_test_fixture_like_cpp.represented_trade_client_state_index_like_cpp,
                        server_state_index: self.trade_test_fixture_like_cpp.represented_trade_server_state_index_like_cpp,
                        items: self.trade_test_fixture_like_cpp.represented_trade_items_like_cpp,
                        money: self.trade_test_fixture_like_cpp.represented_trade_money_like_cpp,
                        spell_id: self.trade_test_fixture_like_cpp.represented_trade_spell_like_cpp,
                        spell_cast_item_guid: self.trade_test_fixture_like_cpp.represented_trade_spell_cast_item_like_cpp,
                    }),
            );
        }
        canonical
    ...
    pub(in crate::session) fn mutate_player_trade_state_like_cpp<R>(
        ...
        if self.player_handle_like_cpp.is_none() {
            if let Some(state) = state {
                self.trade_test_fixture_like_cpp.represented_active_trade_partner_like_cpp = Some(state.partner_guid);
                self.trade_test_fixture_like_cpp.represented_trade_accepted_like_cpp = state.accepted;
                self.trade_test_fixture_like_cpp.represented_partner_trade_server_state_index_like_cpp =
                    state.partner_server_state_index;
                self.trade_test_fixture_like_cpp.represented_trade_client_state_index_like_cpp = state.client_state_index;
                self.trade_test_fixture_like_cpp.represented_trade_server_state_index_like_cpp = state.server_state_index;
                ...
                self.trade_test_fixture_like_cpp.represented_trade_spell_cast_item_like_cpp = state.spell_cast_item_guid;
            } else {
                ...
                self.trade_test_fixture_like_cpp.represented_partner_trade_server_state_index_like_cpp = 0;
                self.trade_test_fixture_like_cpp.represented_trade_client_state_index_like_cpp = 1;
                self.trade_test_fixture_like_cpp.represented_trade_server_state_index_like_cpp = 1;
                self.trade_test_fixture_like_cpp.represented_trade_items_like_cpp = [None; TRADE_SLOT_COUNT_LIKE_CPP as usize];
                ...
                self.trade_test_fixture_like_cpp.represented_trade_spell_cast_item_like_cpp = None;
            }
            return Some(result);
        }
    ...
    pub(crate) fn represented_trade_cancel_statuses_like_cpp(&self) -> &[u8] {
        &self.trade_test_fixture_like_cpp.represented_trade_cancel_statuses_like_cpp
    }
}
