...
impl WorldSession {
    ...
    pub fn set_player_create_info_store_like_cpp(
        ...
        self.player_bootstrap_catalog_test_fixture_like_cpp.player_create_info_store_like_cpp = Some(store);
    }
    ...
    pub fn set_rested_xp_config_like_cpp(
        ...
        self.rest_mgr_test_fixture_like_cpp.rest_ingame_rate_like_cpp = rest_ingame_rate;
    }
