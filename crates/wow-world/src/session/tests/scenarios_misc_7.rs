...
fn rested_xp_uses_configured_rest_rates_like_cpp() {
    ...
    online.rest_mgr_test_fixture_like_cpp.represented_rest_time_secs_like_cpp = 1_000;
...
fn zero_integer_rest_award_normalizes_raf_state_without_touching_rest_flags_like_cpp() {
    ...
    let rest_time = session.rest_mgr_test_fixture_like_cpp.represented_rest_time_secs_like_cpp;
    ...
    assert_eq!(
        session.rest_mgr_test_fixture_like_cpp.represented_rest_flag_mask_like_cpp,
    ...
    assert_eq!(session.rest_mgr_test_fixture_like_cpp.represented_inn_area_trigger_id_like_cpp, 42);
    assert!(session.represented_is_resting_like_cpp());
    assert!(
        session
...
fn online_rest_update_adds_rested_xp_after_ten_seconds_like_cpp() {
    ...
    assert!(session.set_represented_rest_flag_like_cpp(REST_FLAG_IN_CITY_LIKE_CPP, 0));
    session.rest_mgr_test_fixture_like_cpp.represented_rest_time_secs_like_cpp = 1_000;
    ...
    assert!(extra > 0.0);
    assert_eq!(nested_mask, 0x07);
    assert_eq!(session.rest_mgr_test_fixture_like_cpp.represented_rest_time_secs_like_cpp, 1_010);
...
fn online_rest_tick_only_accrues_when_cpp_three_percent_gate_passes() {
    ...
    assert_eq!(session.rest_mgr_test_fixture_like_cpp.represented_rest_time_secs_like_cpp, 1_000);
    assert_eq!(session.represented_xp_rest_bonus_like_cpp(), 0.0);
