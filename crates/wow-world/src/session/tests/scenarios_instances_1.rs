...
fn create_map_player_context_uses_solo_recent_instance_like_cpp() {
    ...
    session.instance_test_fixture_like_cpp.represented_dungeon_difficulty_id_like_cpp = 2;
    session.set_represented_player_recent_instance_like_cpp(631, 9001);
...
fn create_map_player_context_uses_legacy_raid_difficulty_like_cpp() {
    ...
    session.instance_test_fixture_like_cpp.represented_raid_difficulty_id_like_cpp = 15;
    session.instance_test_fixture_like_cpp.represented_legacy_raid_difficulty_id_like_cpp = 4;
