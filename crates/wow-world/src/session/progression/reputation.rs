...
impl WorldSession {
    ...
    pub fn set_start_all_reputation_like_cpp(&mut self, enabled: bool) {
        self.player_bootstrap_catalog_test_fixture_like_cpp.start_all_reputation_like_cpp = enabled;
    }
    #[cfg(test)]
    pub(crate) fn start_all_reputation_like_cpp(&self) -> bool {
        self.player_bootstrap_catalog_test_fixture_like_cpp.start_all_reputation_like_cpp
    }
