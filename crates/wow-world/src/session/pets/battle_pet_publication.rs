...
impl WorldSession {
    ...
    pub(crate) fn send_battle_pet_updates_like_cpp(
        ...
        let pets: Vec<_> = pet_guids
            .iter()
            .filter_map(|pet_guid| {
                let pet = self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp.get(pet_guid)?;
    ...
    pub(crate) fn battle_pet_update_notify_like_cpp(&mut self, pet_guid: ObjectGuid) -> bool {
        ...
        #[cfg(test)]
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_data_updates_like_cpp
            .push(pet_guid);
        true
    }
    #[cfg(test)]
