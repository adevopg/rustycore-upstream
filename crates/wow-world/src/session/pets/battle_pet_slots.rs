...
impl WorldSession {
    ...
    pub(crate) fn complete_represented_battle_pet_slot_authority_load_like_cpp(
        ...
        self.invalidate_canonical_player_spell_hit_aura_authority_like_cpp();
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_slots_authority_complete_like_cpp = false;
        ...
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_slots_like_cpp = slots;
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_slots_authority_complete_like_cpp = true;
        true
    }
    #[cfg(test)]
