...
impl WorldSession {
    ...
    pub fn set_battle_pet_breed_quality_store(&mut self, store: Arc<BattlePetBreedQualityStore>) {
        self.battle_pet_test_fixture_like_cpp.battle_pet_breed_quality_store = Some(store);
    }
    pub(in crate::session) fn battle_pet_xp_per_level_like_cpp(&self, level: u16) -> Option<u16> {
        ...
        return canonical.or_else(|| {
            self.battle_pet_test_fixture_like_cpp.battle_pet_xp_game_table
                .as_ref()
                .and_then(|table| table.xp_per_level_like_cpp(level))
                .or_else(|| {
                    self.battle_pet_test_fixture_like_cpp.represented_battle_pet_xp_per_level_like_cpp
                        .get(&level)
                        .copied()
                })
        });
    ...
    pub(crate) fn has_represented_battle_pet_journal_lock_like_cpp(&self) -> bool {
        ...
        #[cfg(test)]
        return self.battle_pet_test_fixture_like_cpp.represented_battle_pet_journal_lock_like_cpp;
        #[cfg(not(test))]
        false
    }
    ...
    pub(crate) async fn send_battle_pet_journal_lock_status_like_cpp(&mut self) {
        ...
        #[cfg(test)]
        {
            self.battle_pet_test_fixture_like_cpp.represented_battle_pet_journal_lock_like_cpp = true;
            self.send_packet_realm(&wow_packet::packets::misc::BattlePetJournalLockAcquired);
        }
        #[cfg(not(test))]
        self.send_packet_realm(&wow_packet::packets::misc::BattlePetJournalLockDenied);
    ...
    pub(crate) fn represented_battle_pet_journal_like_cpp(
        ...
        #[cfg(test)]
        {
            ...
            for (pet_guid, pet) in &self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp {
            ...
            for slot in &self.battle_pet_test_fixture_like_cpp.represented_battle_pet_slots_like_cpp {
