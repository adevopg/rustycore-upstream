...
impl WorldSession {
    ...
    pub fn set_battle_pet_selection_store_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.battle_pet_selection_store_like_cpp = Some(store);
    }
    #[cfg(test)]
    pub(crate) fn battle_pet_selection_store_like_cpp(
        &self,
    ) -> Option<&Arc<wow_data::battle_pet_selection::BattlePetSelectionStoreLikeCpp>> {
        self.battle_pet_test_fixture_like_cpp.battle_pet_selection_store_like_cpp.as_ref()
    }
    ...
    pub(crate) fn set_battle_pet_purchase_selection_override_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.battle_pet_purchase_selection_override_like_cpp = selection;
    }
    #[cfg(test)]
    pub(crate) fn battle_pet_purchase_selection_override_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.battle_pet_purchase_selection_override_like_cpp
    }
    #[cfg(test)]
    pub fn set_battle_pet_breed_state_store(&mut self, store: Arc<BattlePetBreedStateStore>) {
        self.battle_pet_test_fixture_like_cpp.battle_pet_breed_state_store = Some(store);
    }
    #[cfg(test)]
    pub fn set_battle_pet_species_store(&mut self, store: Arc<BattlePetSpeciesStore>) {
        self.battle_pet_test_fixture_like_cpp.battle_pet_species_store = Some(store);
    }
    #[cfg(test)]
    pub fn set_battle_pet_species_state_store(&mut self, store: Arc<BattlePetSpeciesStateStore>) {
        self.battle_pet_test_fixture_like_cpp.battle_pet_species_state_store = Some(store);
    }
    #[cfg(test)]
    pub fn set_battle_pet_xp_game_table(&mut self, table: Arc<BattlePetXpGameTableLikeCpp>) {
        self.battle_pet_test_fixture_like_cpp.battle_pet_xp_game_table = Some(table);
    }
    pub(crate) fn battle_pet_calculate_stats_like_cpp(
        ...
        #[cfg(test)]
        {
            let stats = calculate_battle_pet_stats_like_cpp(
                ...
                quality,
                level,
                self.battle_pet_test_fixture_like_cpp.battle_pet_breed_state_store.as_ref()?,
                self.battle_pet_test_fixture_like_cpp.battle_pet_species_state_store.as_ref()?,
                self.battle_pet_test_fixture_like_cpp.battle_pet_breed_quality_store.as_ref()?,
            )?;
    ...
    pub(in crate::session) fn battle_pet_species_has_flag_like_cpp(
        ...
        #[cfg(test)]
        return self
            .battle_pet_test_fixture_like_cpp.battle_pet_species_store
            .as_ref()
    ...
    pub(crate) fn add_represented_battle_pet_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp.insert(
            pet_guid,
    ...
    pub(crate) fn battle_pet_clear_fanfare_like_cpp(&mut self, pet_guid: ObjectGuid) -> bool {
        let Some(pet) = self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp.get_mut(&pet_guid) else {
            return false;
        };
    ...
    pub(crate) fn battle_pet_cage_battle_pet_represented_like_cpp(
        ...
        let Some(pet) = self
            .battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp
            .get(&pet_guid)
            .cloned()
        else {
        ...
        if self
            .battle_pet_test_fixture_like_cpp.represented_battle_pet_slots_like_cpp
            .iter()
        ...
        #[cfg(test)]
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_cage_items_like_cpp
            .push(cage_item);
        #[cfg(not(test))]
        let _ = cage_item;
        ...
        if self.represented_summoned_battle_pet_guid_like_cpp() == Some(pet_guid) {
            ...
            #[cfg(test)]
            if _cleared.is_none() {
                self.battle_pet_test_fixture_like_cpp.represented_summoned_battle_pet_guid_like_cpp = None;
            }
        }
    ...
    pub(crate) fn battle_pet_add_pet_represented_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp.insert(pet_guid, pet);
        self.send_battle_pet_updates_like_cpp(&[pet_guid], true);
        #[cfg(test)]
        {
            self.battle_pet_test_fixture_like_cpp.represented_battle_pet_unique_owned_criteria_like_cpp = self
                .battle_pet_test_fixture_like_cpp.represented_battle_pet_unique_owned_criteria_like_cpp
                .saturating_add(1);
            self.battle_pet_test_fixture_like_cpp.represented_battle_pet_learned_new_pet_criteria_like_cpp
                .push(species);
        }
    ...
    pub(crate) fn record_battle_pet_trainer_purchase_criteria_like_cpp(&mut self, species: u32) {
        ...
        #[cfg(test)]
        {
            self.battle_pet_test_fixture_like_cpp.represented_battle_pet_unique_owned_criteria_like_cpp = self
                ...
                .unwrap_or_else(|| {
                    u32::try_from(
                        self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp
                            .values()
                            .map(|pet| pet.species)
                            .collect::<BTreeSet<_>>()
                            .len(),
            ...
            if !self
                .battle_pet_test_fixture_like_cpp.represented_battle_pet_learned_new_pet_criteria_like_cpp
                .contains(&species)
            {
                self.battle_pet_test_fixture_like_cpp.represented_battle_pet_learned_new_pet_criteria_like_cpp
                    .push(species);
    ...
    pub(crate) fn battle_pet_heal_battle_pets_pct_like_cpp(&mut self, pct: u8) -> usize {
        ...
        for (pet_guid, pet) in &mut self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp {
    ...
    pub(crate) fn battle_pet_grant_battle_pet_experience_represented_like_cpp(
        ...
        let Some(pet) = self.battle_pet_test_fixture_like_cpp.represented_battle_pets_like_cpp.get(&pet_guid) else {
        ...
        while total_xp >= next_level_xp && level < MAX_BATTLE_PET_LEVEL_LIKE_CPP {
            ...
            #[cfg(test)]
            {
                ...
                self.battle_pet_test_fixture_like_cpp.represented_battle_pet_level_criteria_like_cpp
                    .push(criteria);
                if xp_source == RepresentedBattlePetXpSourceLikeCpp::PetBattle {
                    self.battle_pet_test_fixture_like_cpp.represented_battle_pet_active_level_criteria_like_cpp
                        .push(criteria);
                }
            }
        }
    ...
    pub(crate) fn represented_battle_pet_unique_owned_criteria_like_cpp(&self) -> u32 {
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_unique_owned_criteria_like_cpp
    }
    #[cfg(test)]
    ...
    pub(crate) fn represented_summoned_battle_pet_guid_like_cpp(&self) -> Option<ObjectGuid> {
        ...
        #[cfg(test)]
        {
            self.battle_pet_test_fixture_like_cpp.represented_summoned_battle_pet_guid_like_cpp
        }
        #[cfg(not(test))]
        {
            None
    ...
    pub(in crate::session) fn set_represented_summoned_battle_pet_guid_like_cpp(
        ...
        #[cfg(test)]
        {
            self.battle_pet_test_fixture_like_cpp.represented_summoned_battle_pet_guid_like_cpp = pet_guid;
            true
        }
        #[cfg(not(test))]
        {
    ...
    pub(crate) fn set_represented_battle_pet_query_companion_like_cpp(
        ...
        self.battle_pet_test_fixture_like_cpp.represented_battle_pet_query_companions_like_cpp
