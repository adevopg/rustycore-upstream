...
pub(crate) const RACE_HUMAN_LIKE_CPP: u8 = 1;
pub(crate) const MAX_RACES_LIKE_CPP: u8 = 78;
pub(crate) const CLASS_WARRIOR_LIKE_CPP: u8 = 1;
pub(crate) const MAX_CLASSES_LIKE_CPP: u8 = 15;
