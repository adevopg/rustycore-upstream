//! `DBFilesClientList` from TrinityCore `src/tools/map_extractor/loadlib/DBFilesClientList.h`
//! (tag TDB343.24081): every DB2 the extractor copies to `dbc/<locale>/`, as
//! `(FileDataID, file name)` in the same order as the C++ array.

/// `DB2FileInfo const DBFilesClientList[]` (ids kept digit-for-digit as in the C++).
#[allow(clippy::unreadable_literal)]
pub(crate) const DB_FILES_CLIENT_LIST: &[(u32, &str)] = &[
