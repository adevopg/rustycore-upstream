export default {
  ...
  base: '/rustycore-upstream/',
  cleanUrls: true,
  appearance: true,
  srcExclude: ['README.md'],
  head: [
    ['link', { rel: 'icon', href: '/rustycore-upstream/logo.svg', type: 'image/svg+xml' }],
    ['meta', { name: 'theme-color', content: '#0a111b' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:site_name', content: 'RustyCore' }],
    ['meta', { property: 'og:image', content: 'https://adevopg.github.io/rustycore-upstream/rustycore-banner.png' }],
